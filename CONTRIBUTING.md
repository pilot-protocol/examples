...
Thanks for your interest in contributing to `examples` — Pilot Protocol example programs — Go SDK demos, CLI shell scripts, Python SDK examples.

## Quick start

```bash
git clone https://github.com/pilot-protocol/examples.git
cd examples
